...
import { JDefaultAuthenticatedUserSchema, JDefaultTaskIdSchema, JDefaultSchemaValidateOptions } from "../joi/joi-default.schema";

import { TaskStatus } from "../../entities/task/task.entity";

export const JTasksTaskUpdateParam: IJoiInput = {
    schema: Joi.object({
...
export const JTasksTaskUpdateBody: IJoiInput = {
    schema: Joi.object({
...
export const JTasksTaskUpdateDateConclusionParam: IJoiInput = {
    schema: Joi.object({
        ...JDefaultTaskIdSchema
    }),
    schemaValidateOptions: {
...
export const JTasksTaskUpdateDateConclusionBody: IJoiInput = {
    schema: Joi.object({
        ...JDefaultAuthenticatedUserSchema,
        taskCompleted: Joi.boolean().required()
    }),
    schemaValidateOptions: {
        ...JDefaultSchemaValidateOptions,
        convert: false
